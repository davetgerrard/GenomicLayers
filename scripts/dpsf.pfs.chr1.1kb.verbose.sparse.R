...
#    reduced number of events back to 100000 to compare run time with chr22 
...
transcript.file <- 'data/hg19.G19.chr1.transcript.gtf'
...
logCycle<- 100 
maxNoChange<- 1000
runName <- "pfs_layer5_chr1_1kb_verbose_sparse"
outputDir <- paste("results/",runName, sep="")
