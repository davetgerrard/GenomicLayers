...
GENOME <- 'mm9'
par.outFile <- paste0(OUTPUTDIR, "parallel.runTest.6.txt")
...
system.time(
  resultsVec <- clusterApplyLB(cl, 1:6, fun=function(x) layerBindAndScore(layerList=layerList.X, factorSet = XFS.10, iterations = n.iters*n.waves,
