...
layerList.X <- createLayerList.DNAstring(seq=thisChrom, layerNames=c("CpG_island","PRC","H3K27me3"))
...
modLayer <- runLayerBinding( layerList=layerList.X, factorSet = XFS.10, iterations =n.iters)
